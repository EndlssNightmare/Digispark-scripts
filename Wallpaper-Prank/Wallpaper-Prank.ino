//Este script para o digispark faz uma captura de tela da área de trabalho, define-a como papel de parede e oculta os ícones da área de trabalho.
//Funciona no Windows XP(?)/Vista(?)/7/8/8.1/10 etc.
